...
public class PalindromeBinary {
    ...
    /*
     * Construct the nth binary palindrome with the given group number, aux_number
     * and operation type
     */
    private static int constructNthNumber(int group_no, int aux_num, int op) {
    ...
    // Optimised
    public int solveOptimsed(int n) {
